...
const PROJECTS = [
  {
    ...
    cat:'web' as Cat, accent:'#8B5CF6', bg:'#F5F3FF', year:'2024', impact:'10k+ produits',
  ...
  },
  {
    ...
    cat:'web' as Cat, accent:'#0EA5E9', bg:'#F0F9FF', year:'2023', impact:'50+ utilisateurs',
    gradient:'linear-gradient(135deg, #0EA5E9, #00C896)',
  },
  {
    ...
    cat:'game' as Cat, accent:'#FF6B35', bg:'#FFF4F0', year:'2023', impact:'Indie · Shipped',
    gradient:'linear-gradient(135deg, #FF6B35, #FFBD35)',
  },
  {
    ...
    cat:'3d' as Cat, accent:'#FF2D78', bg:'#FFF0F5', year:'2024', impact:'Web · Interactive',
    gradient:'linear-gradient(135deg, #FF2D78, #8B5CF6)',
  },
  {
    ...
    cat:'web' as Cat, accent:'#00C896', bg:'#F0FDF9', year:'2024', impact:'Production · Live',
    gradient:'linear-gradient(135deg, #00C896, #0EA5E9)',
  },
  {
    ...
    cat:'3d' as Cat, accent:'#FFBD35', bg:'#FFFBF0', year:'2023', impact:'3D Assets',
    gradient:'linear-gradient(135deg, #FFBD35, #FF6B35)',
  },
]

const FILTERS: {label:string;value:Cat;color:string;bg:string}[] = [
  {label:'Tout',       value:'all',  color:'#1A1630', bg:'white'    },
  {label:'Web Apps',   value:'web',  color:'#8B5CF6', bg:'#F5F3FF'  },
  {label:'3D / WebGL', value:'3d',   color:'#FF6B35', bg:'#FFF4F0'  },
  {label:'Game Dev',   value:'game', color:'#00C896', bg:'#F0FDF9'  },
]
    ...
    <section id="projects" ref={ref} style={{ padding:'100px 0', position:'relative', background:'transparent' }}>
      ...
      <style>{`
        ...
        .proj-card:hover {
          ...
          box-shadow:0 20px 52px rgba(26,22,48,0.14);
        ...
        .f-btn {
          ...
          transition:all 0.22s; letter-spacing:0.5px; text-transform:uppercase;
        }
      `}</style>
      ...
      <div className="container">
        ...
        <div className={`pj ${inView?'v':''}`} style={{ animationDelay:'0s', marginBottom:'56px' }}>
          <p className="section-label" style={{ color:'#FF2D78' }}>✦ Projets</p>
          ...
          <div style={{ width:'70px', height:'5px', borderRadius:'3px',
            background:'linear-gradient(90deg,#FF2D78,#FF6B35)', marginBottom:'20px' }} />
          <p className="section-sub">Web · 3D · Jeux. Des projets livrés, pas juste démarrés.</p>
        </div>

        {/* Filter buttons */}
        <div className={`pj ${inView?'v':''}`} style={{
          animationDelay:'0.1s',
          display:'flex', gap:'8px', marginBottom:'44px', flexWrap:'wrap',
        }}>
          {FILTERS.map(f => (
            <button key={f.value}
              className="f-btn"
              ...
              style={{
                background: active===f.value ? f.bg : 'white',
                color: active===f.value ? f.color : '#5A5878',
                borderColor: active===f.value ? `${f.color}40` : 'rgba(26,22,48,0.12)',
        ...
        <div style={{
          ...
          {list.map((p, i) => (
            <div key={p.id} className={`proj-card pj ${inView?'v':''}`}
              ...
              {/* Gradient banner */}
              <div style={{
                height:'120px', background:p.gradient,
                ...
                {/* Year pill */}
                <span style={{
                  position:'absolute', top:'12px', left:'14px', zIndex:1,
                ...
                {/* Status */}
                <span style={{
                  position:'absolute', top:'12px', right:'14px', zIndex:1,
                  fontFamily:"'JetBrains Mono',monospace", fontSize:'10px',
                  color:'white', background:'rgba(0,200,150,0.7)',
                  padding:'3px 10px', borderRadius:'999px',
              ...
              <div style={{ padding:'20px 22px', flex:1, display:'flex', flexDirection:'column' }}>
                ...
                <span style={{
                  ...
                  background:p.bg, border:`1.5px solid ${p.accent}30`,
                  padding:'3px 10px', borderRadius:'999px',
                ...
                <h3 style={{ fontSize:'1rem', fontWeight:800, color:'#1A1630',
                  marginBottom:'8px', lineHeight:1.3 }}>
                  {p.title}
                </h3>
                <p style={{ fontSize:'0.84rem', color:'#5A5878', lineHeight:1.7,
              ...
              <div style={{
                ...
                borderTop:'1px solid rgba(26,22,48,0.07)',
                ...
                <div style={{ display:'flex', flexWrap:'wrap', gap:'5px' }}>
                  ...
                  {p.tags.length > 3 && (
                    <span className="tag" style={{ fontSize:'10px', padding:'3px 9px' }}>
                      +{p.tags.length - 3}
                    </span>
                  )}
                </div>
        ...
        {/* GitHub CTA */}
        <div className={`pj ${inView?'v':''}`} style={{
          animationDelay:'0.7s', textAlign:'center', marginTop:'52px',
        }}>
          <a href="https://github.com/lynda-imakhlaf" target="_blank" rel="noopener noreferrer"
            style={{
              ...
              boxShadow:'0 4px 16px rgba(26,22,48,0.08)',
              transition:'all 0.28s',
            }}
            onMouseEnter={e=>{ const el=e.currentTarget as HTMLAnchorElement; el.style.borderColor='#8B5CF6'; el.style.color='#8B5CF6'; el.style.transform='translateY(-3px)'; el.style.boxShadow='0 8px 24px rgba(139,92,246,0.2)'; }}
            onMouseLeave={e=>{ const el=e.currentTarget as HTMLAnchorElement; el.style.borderColor='rgba(26,22,48,0.12)'; el.style.color='#1A1630'; el.style.transform='translateY(0)'; el.style.boxShadow='0 4px 16px rgba(26,22,48,0.08)'; }}
          >
